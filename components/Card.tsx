    ...
    <div className="card">
      <div className="card__header">
        <div className="card__picture">
          ...
          <img src={`img/tours/${imageCover}`} alt={`${name}`} className="card__picture-img" />
        </div>
      ...
      <div className="card__details">
        ...
        <div className="card__data">
          ...
          <span>{new Date(startDates[0]).toLocaleString("en-us", { month: "long", year: "numeric" })}</span>
        </div>
        <div className="card__data">
          <svg className="card__icon">
      ...
      <div className="card__footer">
        ...
        <Link href={`/tours/${slug}`}  className="btn btn--green btn--small">
          Details
        </Link>
      </div>
    </div>
